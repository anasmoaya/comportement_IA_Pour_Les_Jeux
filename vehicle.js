...
// Set fill color for the bird body
fill(0, 150, 200); // Blue color for the bird body

// Translate to the bird's position
translate(this.pos.x, this.pos.y);

// Draw the bird body
ellipse(0, 0, 30, 30); // Circular body

// Draw the bird wings
triangle(-15, 0, 0, -10, 0, 10); // Left wing
triangle(15, 0, 0, -10, 0, 10);  // Right wing
...
// Circle for avoidance between birds and obstacles
if (Vehicle.debug) {
  stroke(255);
  noFill();
  ...
  stroke(255);
  strokeWeight(2);
  fill(this.couleur); // Ghost color
  push();
  translate(this.pos.x, this.pos.y);
  rotate(this.vel.heading());
  ellipse(0, 0, 20, 40); // Ghost body
  noStroke();
  fill(255); // Eyes color
  ellipse(-5, -10, 5, 5); // Left eye
  ellipse(5, -10, 5, 5);  // Right eye
  pop();
